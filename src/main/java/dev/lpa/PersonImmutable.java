...
public class PersonImmutable {
    ...
    public PersonImmutable(String name, String dob, PersonImmutable[] kids) {
        this.name = name;
        this.dob = dob;
        this.kids = kids == null ? null : Arrays.copyOf(kids, kids.length); // Defensive strategy to force immutability.
    }
    ...
    /* This is a defensive strategy to force immutability.
    * Make this final is the key.*/
